...
数据目录：[task1/data/20260911_task1](../data/20260911_task1)

实现范围：使用仓库 `solution` 控制器，新增实验、汇总与校验脚本，未修改原控制器或车辆模型。

目录整理说明：本报告、代码和数据已集中到 `task1/`，本次仅调整路径，不改变实验数值与结论。
历史清单中的旧路径和脚本哈希保留原值，其映射与原始脚本快照见
[版本追溯说明](../provenance/README.md)。
...
python task1/scripts/run_task1.py --output task1/outputs/reproduction --jobs 3
python task1/scripts/analyze_task1.py --input task1/outputs/reproduction --output task1/outputs/reproduction_report
...
| [manifest.json](../data/20260911_task1/manifest.json) | 代码版本、源文件哈希、环境和实验清单 |
